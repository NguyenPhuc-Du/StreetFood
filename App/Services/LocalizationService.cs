...
public static class LocalizationService
{
    ...
    static readonly Dictionary<string, Dictionary<string, string>> Texts = new(StringComparer.OrdinalIgnoreCase)
    {
        ["vi"] = new(StringComparer.Ordinal)
        {
            ...
            ["SettingsApiUrlTitle"] = "Địa chỉ API (backend)",
            ["SettingsApiUrlDesc"] = "Nhập URL đầy đủ, không có / ở cuối. Ví dụ ngrok: https://abc.ngrok-free.app hoặc IP máy dev khi điện thoại cùng Wi‑Fi.",
            ["SettingsApiUrlPlaceholder"] = "https://...",
            ["SettingsApiUrlSave"] = "Lưu URL",
            ["SettingsApiUrlReset"] = "Mặc định",
            ["SettingsApiUrlInvalid"] = "URL không hợp lệ. Dùng http:// hoặc https:// và địa chỉ đầy đủ.",
            ["SettingsApiUrlSaved"] = "Đã lưu địa chỉ API.",
            ["Saved"] = "Đã lưu",
        ...
        ["en"] = new(StringComparer.Ordinal)
        {
            ...
            ["SettingsApiUrlTitle"] = "API base URL (backend)",
            ["SettingsApiUrlDesc"] = "Full URL with no trailing slash. Example ngrok: https://abc.ngrok-free.app or your LAN dev IP on the same Wi‑Fi.",
            ["SettingsApiUrlPlaceholder"] = "https://...",
            ["SettingsApiUrlSave"] = "Save URL",
            ["SettingsApiUrlReset"] = "Use default",
            ["SettingsApiUrlInvalid"] = "Invalid URL. Use http:// or https:// with a full host.",
            ["SettingsApiUrlSaved"] = "API URL saved.",
            ["Saved"] = "Saved",
        ...
        ["ja"] = new(StringComparer.Ordinal)
        {
            ...
            ["SettingsApiUrlTitle"] = "APIのURL（バックエンド）",
            ["SettingsApiUrlDesc"] = "末尾に / を付けない完全なURL。例: ngrokの https://abc.ngrok-free.app または同じWi‑Fiの開発IP。",
            ["SettingsApiUrlPlaceholder"] = "https://...",
            ["SettingsApiUrlSave"] = "保存",
            ["SettingsApiUrlReset"] = "既定に戻す",
            ["SettingsApiUrlInvalid"] = "URLが無効です。http:// または https:// でホストを指定してください。",
            ["SettingsApiUrlSaved"] = "APIのURLを保存しました。",
            ["Saved"] = "保存しました",
        ...
        ["ko"] = new(StringComparer.Ordinal)
        {
            ...
            ["SettingsApiUrlTitle"] = "API 주소(백엔드)",
            ["SettingsApiUrlDesc"] = "끝에 / 없이 전체 URL. 예: ngrok https://abc.ngrok-free.app 또는 같은 Wi‑Fi의 개발 PC IP.",
            ["SettingsApiUrlPlaceholder"] = "https://...",
            ["SettingsApiUrlSave"] = "저장",
            ["SettingsApiUrlReset"] = "기본값",
            ["SettingsApiUrlInvalid"] = "URL이 올바르지 않습니다. http:// 또는 https:// 로 전체 주소를 입력하세요.",
            ["SettingsApiUrlSaved"] = "API 주소를 저장했습니다.",
            ["Saved"] = "저장됨",
        ...
        ["zh"] = new(StringComparer.Ordinal)
        {
            ...
            ["SettingsApiUrlTitle"] = "API 地址（后端）",
            ["SettingsApiUrlDesc"] = "完整 URL，末尾不要加 /。例如 ngrok：https://abc.ngrok-free.app 或同一 Wi‑Fi 下的开发机 IP。",
            ["SettingsApiUrlPlaceholder"] = "https://...",
            ["SettingsApiUrlSave"] = "保存",
            ["SettingsApiUrlReset"] = "恢复默认",
            ["SettingsApiUrlInvalid"] = "URL 无效。请使用 http:// 或 https:// 并填写完整主机名。",
            ["SettingsApiUrlSaved"] = "已保存 API 地址。",
            ["Saved"] = "已保存",
